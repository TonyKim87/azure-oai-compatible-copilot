# ☁️ Azure OAI Compatible Provider for Copilot
...
Use Azure OAI Compatible models like GPT-4, GPT-4 Turbo, GPT-3.5 Turbo and more in VS Code with GitHub Copilot Chat powered by your Azure OAI Compatible resource 🔥

---

## ⚡ Quick Start
1. Install the Azure OAI Compatible Provider for Copilot extension [here](https://marketplace.visualstudio.com/items?itemName=tony-kim.azure-oai-compatible-copilot).
2. Open VS Code Settings and configure your Azure OAI Compatible settings:
   - `baseUrl`: `https://<RESOURCE>.openai.azure.com/openai/deployments/<MODEL>`
   - `azureResourceName`: Your Azure OAI Compatible resource name
...
5. Choose "Azure OAI Compatible" provider.
6. Enter your Azure OAI Compatible API key — it will be saved locally.
7. Select the models you want to add to the model picker.

## ✨ Why Use Azure OAI Compatible Provider in Copilot
- **Enterprise-grade security**: Use your own Azure OAI Compatible resource with enterprise compliance
...
- **Azure Resource Name**: Your Azure OAI Compatible resource name
...
- Azure OAI Compatible resource with deployed models
- Azure OAI Compatible API key
...
## 📚 Azure OAI Compatible Setup Guide

1. **Create Azure OAI Compatible Resource**:
   - Go to Azure Portal → Create Resource → Azure OAI Compatible
...
3. **Get API Key**:
   - Go to your Azure OAI Compatible resource → Keys and Endpoint
